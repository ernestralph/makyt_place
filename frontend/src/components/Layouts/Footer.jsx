...
const Footer = () => {
  return (
    <div className="bg-[#000] text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center pt-2 text-gray-400 pb-8">
        <span>
          &copy; {new Date().getFullYear()} Rateck. All rights reserved.
        </span>
