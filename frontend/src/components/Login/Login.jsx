          ...
          <form action="" className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className={`${styles.normalFlex} justify-between`}>
              <div className={`${styles.normalFlex}`}>
                ...
                />
                <label htmlFor="remeber-me" className="ml-2 block text-sm text-gray-500">Remeber me</label>
              </div>
            ...
            <div>
              <button type="submit" className="group relative w-full h-[40px] flex justify-center py-2 px-4 border border-transparent text-md font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                Submit
              </button>
            </div>
